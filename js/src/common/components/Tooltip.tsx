...
export interface TooltipAttrs extends Mithril.CommonAttributes<TooltipAttrs, Tooltip> {
   ...
   * tooltip library. Be prepared for this to break in Forumkit stable.
   *
   * Default: `false`.
   *
   * @deprecated
   ...
   * library. Be prepared for this to break in Forumkit stable.
   *
   * Default: `0`.
   *
   * @deprecated
 ...
 * Forumkit. This shouldn't be an issue if you're using this component correctly.
 *
