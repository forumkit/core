...
export default class StatusWidget extends DashboardWidget {
  ...
  items() {
    ...
    items.add('version-forumkit', [<strong>Forumkit</strong>, <br />, app.forum.attribute('version')], 100);
      ...
      items.add(
        ...
        [
          <span>
            ...
            <LinkButton href="https://discuss.forumkit.cn/d/24118" external={true} target="_blank" icon="fas fa-info-circle" />
          </span>,
          <br />,
