...
class ExtensionManager
{
    ...
    public function getExtensions()
    {
        if (is_null($this->extensions) && $this->filesystem->exists($this->paths->vendor.'/composer/installed.json')) {
            ...
            // We calculate and store a set of composer package names for all installed Forumkit extensions,
            // so we know what is and isn't a forumkit extension in `calculateDependencies`.
     ...
     * This is resolved dynamically because Forumkit's filesystem configuration
    ...
    /**
     * Call on all enabled extensions to extend the Forumkit application.
     *
     ...
     *      'valid' points to an ordered array of \Forumkit\Extension\Extension
