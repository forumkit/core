...
class User implements ExtenderInterface
{
     ...
     * @param string $driver: ::class attribute of driver class, which must implement Forumkit\User\DisplayName\DriverInterface
     * @return self
     */
     ...
     * - \Forumkit\User\User $user: the user in question.
