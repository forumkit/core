...
namespace Forumkit\Site\Content;
...
class Discussion
{
    ...
    public function __invoke(Document $document, Request $request)
    {
        ...
        $document->content = $this->view->make('forumkit.site::frontend.content.discussion', compact('apiDocument', 'page', 'hasPrevPage', 'hasNextPage', 'getResource', 'posts', 'url'));
