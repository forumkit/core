...
use Forumkit\Extension\Exception as ExtensionException;
use Forumkit\Foundation\ErrorHandling as Handling;
...
class ErrorServiceProvider extends AbstractServiceProvider
{
    ...
    {
        $this->container->singleton('forumkit.error.statuses', function () {
            return [
                // 400 Bad Request
        ...
        $this->container->singleton('forumkit.error.classes', function () {
            return [
        ...
        $this->container->singleton('forumkit.error.handlers', function () {
            return [
        ...
        $this->container->singleton(Handling\Registry::class, function () {
            return new Handling\Registry(
                $this->container->make('forumkit.error.statuses'),
                $this->container->make('forumkit.error.classes'),
                $this->container->make('forumkit.error.handlers')
            );
        });
