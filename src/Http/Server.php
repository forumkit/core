...
class Server
{
    ...
    private function cleanBootExceptionLog(Throwable $error)
    {
        ...
        if ($container->has('forumkit.config') && resolve('forumkit.config')->inDebugMode()) {
            ...
            echo <<<ERROR
            Forumkit encountered a boot error ($type)<br />
            <b>$message</b><br />
...
ERROR;
            ...
            echo 'Forumkit encountered a boot error. Details have been logged to the Forumkit log file.';
            exit(1);
        }
    }
    ...
    {
        echo 'Forumkit encountered a boot error. Details have been logged to the system PHP log file.<br />';
