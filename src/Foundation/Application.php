...
class Application
{
    ...
    /**
     * The IoC container for the Forumkit application.
     *
     * @var Container
     */
    private $container;
    ...
    /**
     * The paths for the Forumkit installation.
     *
     * @var Paths
     */
    protected $paths;
    ...
    /**
     * Create a new Forumkit application instance.
     *
    ...
    /**
     * Check if Forumkit is in debug mode.
     *
     * @return bool
     */
    ...
    /**
     * Get the URL to the Forumkit installation.
     *
     * @param string $path
     * @return string
     */
    ...
    protected function registerBaseBindings()
    {
         ...
         * Use container inside forumkit instead.
         */
