...
export default class StatusWidget extends DashboardWidget {
  ...
  items() {
    ...
    items.add('version-forumkit', [<strong>Forumkit</strong>, <br />, app.site.attribute('version')], 100);
      ...
      items.add(
        ...
        [
          <span>
            ...
            <LinkButton href="https://www.forumkit.cn/discussion/24118" external={true} target="_blank" icon="fas fa-info-circle" />
          </span>,
          <br />,
