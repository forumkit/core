...
class Extension implements Arrayable
{
    ...
    /**
     * The IDs of all Forumkit extensions that this extension depends on.
     *
     * @var string[]
     */
    ...
    /**
     * The IDs of all Forumkit extensions that this extension should be booted after
     * if enabled.
     *
     * @var string[]
     */
    ...
    /**
     * Get the list of forumkit extensions that this extension depends on.
     *
