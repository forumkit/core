...
class Event implements ExtenderInterface
{
    ...
    /**
     * Add a listener to a domain event dispatched by forumkit or a forumkit extension.
     *
    ...
    /**
     * Add a subscriber for a set of domain events dispatched by forumkit or a forumkit extension.
