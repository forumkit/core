...
class ErrorHandling implements ExtenderInterface
{
     ...
     * itself (if it implements {@see \Forumkit\Foundation\KnownError}), or
     ...
     * the exception implement our {@see \Forumkit\Foundation\KnownError}
     ...
     *
     * When Forumkit's default error handling is not enough for you, and the other
     ...
     * returns a {@see \Forumkit\Foundation\ErrorHandling\HandledError} instance.
     ...
     *
     * Reporters will be called whenever Forumkit encounters an exception that it
     ...
     * {@see \Forumkit\Foundation\ErrorHandling\Reporter} interface.
     *
