...
class Model implements ExtenderInterface
{
     ...
     * @param string $related: The ::class attribute of the model, which should extend \Forumkit\Database\AbstractModel.
     ...
     *                  like \Forumkit\User\User for examples of how relationships should be returned.
     *
     * @return self
     */
